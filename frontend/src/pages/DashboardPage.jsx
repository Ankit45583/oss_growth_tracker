...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    if (searchParams.get("error") === "github_already_linked") {
      setErr("This GitHub account is already linked to another user.");
    }
  }, [searchParams]);
  ...
  const handleConnectGithub = () => {
    ...
    setConnecting(true);
    setErr("");
    userService.connectGithub(user._id);
  };
      ...
      {!ghConnected ? (
        ...
        <>
          ...
          <div className="dash-stats-grid">
            <StatCard icon="📦" label="Public Repositories" value={totalRepos} color="blue" subtitle={`From @${ghUsername}`} />
            <StatCard icon="💻" label="Total Commits" value={totalCommits} color="green" subtitle="Across all repos" />
            <StatCard icon="🔥" label="Current Streak" value={`${currentStreak} days`} color="yellow" subtitle={lastCommitText || "No commits yet"} />
            <StatCard icon="🏆" label="Longest Streak" value={`${longestStreak} days`} color="purple" subtitle="Personal best" />
            <StatCard icon="⭐" label="Score" value={score} color="blue" subtitle="Based on commits + streak" />
            <StatCard icon="🆔" label="App Account" value={user.username} color="purple" subtitle="Your app identity" />
          </div>
            ...
            <div className="card dash-tips anim-slide">
              ...
              <div className="dash-tips-grid">
                <div className="dash-tip-item">
                  ...
                  <div>
                    <p className="dash-tip-title">Streak Status: {streakBadge?.label || "No Streak"}</p>
                ...
                <div className="dash-tip-item">
                  ...
                  <div>
                    ...
                    <p className="dash-tip-desc">Click Refresh Data to sync latest GitHub stats.</p>
                  </div>
                </div>
                <div className="dash-tip-item">
                  <span className="dash-tip-emoji">📝</span>
                  <div>
                    ...
                    <p className="dash-tip-desc">Daily commits help improve your streak and score.</p>
                  </div>
                </div>
                <div className="dash-tip-item">
                  <span className="dash-tip-emoji">🏆</span>
                  <div>
                    ...
                    <p className="dash-tip-desc">More commits and stronger streaks improve your rank.</p>
                  </div>
                </div>
              </div>
            </div>
